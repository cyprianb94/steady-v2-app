...
description: Use when making Steady naming, voice, tone, vocabulary, product copy, brand positioning, content hierarchy, or aesthetic-metaphor decisions.
---

# Steady — Brand and Content

Use this skill whenever work touches:
- app, feature, screen, button, empty-state, notification, or marketing copy
- Steady AI naming, persona wording, or the coach-vs-AI distinction
- product positioning, beta scope, or what is/is not promised
- visual metaphor, brand feeling, and whether an interface still feels like Steady

For visual implementation details, pair this with `/design-system`. For screen structure, pair it with `/screens`. For Steady AI behaviour, pair it with `/ai-coach`.
