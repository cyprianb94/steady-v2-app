...
│   ├── coach/                    # Frozen Steady AI components; future extension point only
│   │   ├── CoachHeader.tsx
│   │   ├── MessageBubble.tsx
...
│   ├── anthropic.ts              # Future Claude API wrapper; no live calls during AI freeze
...
│   ├── useCoach.ts               # Future conversation state; frozen for now
