...
Local development keeps the pre-TestFlight redirect generated by Expo: `Linking.createURL('strava-callback')`. Do not set `EXPO_PUBLIC_STRAVA_CALLBACK_DOMAIN` locally unless you deliberately want to test the release-style redirect.
