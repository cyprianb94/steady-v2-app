...
For Steady product UI, the project design system overrides the generic frontend-design advice below. Read `docs/BRAND_AND_CONTENT.md` and `docs/DESIGN_SYSTEM.md`, then preserve the established Steady aesthetic: parchment surfaces, Playfair Display titles, Space Mono numbers, DM Sans UI copy, semantic session colours, tight editorial density, and minimal functional motion.
